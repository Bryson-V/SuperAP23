...
Scanner inp=new Scanner(System.in);
    ...
    {
        String hi=file.nextLine();
        String[] split=hi.split(" ");
        System.out.print(split.length);
//        for(int i=0;i<split.length;i++)
////            System.out.println(split[i]);
        User temp=new User(split[0], split[1].trim());
//        System.out.println(temp.getUsername());
	...
	*/
    ...
    private void addTopic(){
        ...
        String topic=inp.nextLine();
        System.out.print("Please enter a body");
        String body=inp.nextLine();
        Message temp = new Topic(cuser,topic,body,messages.size()+1);
        messages.add(temp);
    ...
    private void setPassword() {
        while (true) {
            ...
            if(oldpass.equals("c") || oldpass.equals("C"))
                break;
            String newpass=inp.nextLine();
            if( users.get(usrnum).setPassword(oldpass, newpass))
            {
